...
from izi_accounts import exceptions
...
class Account(models.Model):
    ...
    # products.  This is the only link with IZI.
...
class Transfer(models.Model):
    ...
    source = models.ForeignKey('izi_accounts.Account', models.CASCADE,
                               related_name='source_transfers')
    destination = models.ForeignKey('izi_accounts.Account', models.CASCADE,
...
class Transaction(models.Model):
    ...
    transfer = models.ForeignKey('izi_accounts.Transfer', models.CASCADE,
                                 related_name="transactions")
    account = models.ForeignKey('izi_accounts.Account', models.CASCADE,
                                related_name='transactions')
