...
from izi_accounts import exceptions, facade, names
from izi_accounts.dashboard import forms, reports

AccountType = get_model('izi_accounts', 'AccountType')
Account = get_model('izi_accounts', 'Account')
Transfer = get_model('izi_accounts', 'Transfer')
Transaction = get_model('izi_accounts', 'Transaction')
...
class AccountListView(generic.ListView):
    ...
    paginate_by = getattr(settings, 'IZI_ACCOUNTS_DASHBOARD_ITEMS_PER_PAGE', 20)
