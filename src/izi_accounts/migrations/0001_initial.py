    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=models.CASCADE, related_name='transactions', to='izi_accounts.Account')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('destination', models.ForeignKey(on_delete=models.CASCADE, related_name='destination_transfers', to='izi_accounts.Account')),
                ('parent', models.ForeignKey(on_delete=models.CASCADE, related_name='related_transfers', to='izi_accounts.Transfer', null=True)),
                ('source', models.ForeignKey(on_delete=models.CASCADE, related_name='source_transfers', to='izi_accounts.Account')),
        ...
        migrations.AddField(
            ...
            name='transfer',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='transactions', to='izi_accounts.Transfer'),
        ...
        migrations.AddField(
            model_name='account',
            name='account_type',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='accounts', to='izi_accounts.AccountType', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='account',
