...
from izi.apps.checkout import views
from izi.apps.payment import exceptions
from izi.apps.payment.models import Source, SourceType

from izi_accounts import exceptions as act_exceptions
from izi_accounts import security
from izi_accounts.checkout import forms, gateway
from izi_accounts.checkout.allocation import Allocations
...
class PaymentDetailsView(views.PaymentDetailsView):
    ...
    # izi.apps.checkout.utils.CheckoutSessionData.  They are kept here for
    # simplicity
