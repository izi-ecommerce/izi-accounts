...
from izi_accounts import facade, exceptions
from izi_accounts.models import Account, Transfer, Transaction
from izi_accounts.test_factories import AccountFactory
...
class TestErrorHandling(TransactionTestCase):
    ...
    def test_no_transaction_created_when_exception_raised(self):
        ...
        source = AccountFactory(credit_limit=None)
        destination = AccountFactory()
        with mock.patch('izi_accounts.abstract_models.PostingManager._wrap') as mock_method:
